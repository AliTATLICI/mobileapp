...
class OBSGirisSayfasi extends StatefulWidget {
final MainModel model;

  OBSGirisSayfasi(this.model);

  @override
  State<StatefulWidget> createState() {
    // TODO: implement createState
    return _OBSGirisSayfasiState();
  }
}

class _OBSGirisSayfasiState extends State<OBSGirisSayfasi> with TickerProviderStateMixin {
  ...
  DecorationImage _buildBackgroundImage() {
    return DecorationImage(
      ...
      image: AssetImage('assets/sdu_obs_giris.jpg'),
    );
  }
