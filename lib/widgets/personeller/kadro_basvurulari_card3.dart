...
class KadroBasvuruCard3 extends StatelessWidget {
  final KadroBasvuru kadro;
  final int kadroIndex;

  KadroBasvuruCard3(this.kadro, this.kadroIndex);
          ...
          children: <Widget>[
            FlatButton(
              child: Row(children: <Widget>[
                ...
                Text(kadro.kadroTuru == "U" ? "Unvan Değişikliği Sınavı: " : "Görevde Yükselme Sınavı :"),
                SizedBox(width: 5,),
                Text('Yazılı: ??'),
                SizedBox(width: 10.0,),
                Text('Sözlü: ??')
                //getJuriWidgets(kadro.kadroTuru == "M" ? 5 : 5 , kadro.juriler),
                //SizedBox(width: 15.0,)       
